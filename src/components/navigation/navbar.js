                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6">
                    <div
                        ...
                        <Popover.Group as="nav" className="hidden space-x-10 md:flex">
                            ...
                            <Link to="/" className="text-base font-medium text-gray-500 hover:text-gray-900" href="#">Home </Link>
                            <Link to="/product" className="text-base font-medium text-gray-500 hover:text-gray-900" href="#">Product </Link>
                                            ...
                                            <Popover.Panel
                                                ...
                                                <div
                                                    ...
                                                    <div className="bg-gray-50 px-5 py-5 sm:px-8 sm:py-8">
                                                        <div>
                                                            <h3 className="text-base font-medium text-gray-500">Recent
                                                                Posts</h3>
                        ...
                        <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                            <Link to="/signin" className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900" href="#">Sign in</Link>
                            <Link to="/signup" className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700" href="#">Sign up</Link>
                        </div>
                    </div>
                </div>
